...
\newcommand{\insertImage}[4][width=100mm]{
	\begin{figure}[H]
		\centering
		\includegraphics[#1]{#2}
		\caption{#3}
...
%style=gost-numeric,   % Имя вашего .bbx-стиля (без расширения)
%sorting=none,         % Порядок цитирования
%language=auto,        % Автоматическое определение языка
%autolang=other        % Поддержка многоязычных библиографических записей
%]{biblatex}
%
%\addbibresource{parts/lib.bib}  % Путь к вашему .bib-файлу
